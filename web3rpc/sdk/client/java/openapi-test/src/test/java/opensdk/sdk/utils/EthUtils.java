...
public class EthUtils {
    ...
    public static org.web3j.protocol.core.methods.response.EthFilter getEthFilter() throws IOException {
        ...
        org.web3j.protocol.core.methods.response.EthFilter response = CommonUtils.w3ForPN.ethNewFilter(filterOption).send();
        return response;
    }
