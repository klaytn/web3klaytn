...
describe('klay_recoverFromTransaction API', () => {
    test('should return klay_recoverFromTransaction', (done) => {
        ...
        sdk.klay.recoverFromTransaction(rlpEncoded, blockNumber, {}, callbackOne);
    });
});
