...
class ValueTransferWithMemoTransaction(_TypedTransactionImplementation):
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "ValueTransferWithMemoTransaction":
        """
        Builds a ValueTransferWithMemoTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "ValueTransferWithMemoTransaction":
        """Builds a ValueTransferWithMemoTransaction from a signed encoded transaction."""
