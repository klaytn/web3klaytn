...
class CancelTransaction(_TypedTransactionImplementation):
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "CancelTransaction":
        """
        Builds a CancelTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "CancelTransaction":
        """Builds a CancelTransaction from a signed encoded transaction."""
