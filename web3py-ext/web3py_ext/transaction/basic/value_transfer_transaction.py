...
class ValueTransferTransaction(_TypedTransactionImplementation):
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "ValueTransferTransaction":
        """
        Builds a ValueTransferTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "ValueTransferTransaction":
        """Builds a ValueTransferTransaction from a signed encoded transaction."""
