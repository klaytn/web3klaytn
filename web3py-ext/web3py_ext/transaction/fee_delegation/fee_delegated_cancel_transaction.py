...
class FeeDelegatedCancelTransaction(_TypedTransactionImplementation):
    """
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "FeeDelegatedCancelTransaction":
        """
        Builds a FeeDelegatedCancelTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "FeeDelegatedCancelTransaction":
        """Builds a FeeDelegatedCancelTransaction from a signed encoded transaction."""
