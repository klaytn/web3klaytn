...
class FeeDelegatedSmartContractDeployTransaction(_TypedTransactionImplementation):
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "FeeDelegatedSmartContractDeployTransaction":
        """
        Builds a FeeDelegatedSmartContractDeployTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "FeeDelegatedSmartContractDeployTransaction":
        """Builds a FeeDelegatedSmartContractDeployTransaction from a signed encoded transaction."""
