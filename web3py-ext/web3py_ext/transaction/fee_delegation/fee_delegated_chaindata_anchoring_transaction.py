...
class FeeDelegatedChaindataAnchoringTransaction(_TypedTransactionImplementation):
    ...
    @classmethod
    def from_dict(cls, dictionary: Dict[str, Any]) -> "FeeDelegatedChaindataAnchoringTransaction":
        """
        Builds a FeeDelegatedChaindataAnchoringTransaction from a dictionary.
    ...
    @classmethod
    def from_bytes(cls, encoded_transaction: HexBytes) -> "FeeDelegatedChaindataAnchoringTransaction":
        """Builds a FeeDelegatedChaindataAnchoringTransaction from a signed encoded transaction."""
