...
class SubbridgeApi(Module):
    ...
    _add_peer2: Method[Callable[..., Any]] = Method(
        namespace + "_addPeer2", mungers=[default_root_munger]
    )

    def add_peer2(self, *args) -> Any:
        return self._add_peer2(*args)
    ...
    _node_info2: Method[Callable[..., Any]] = Method(
        namespace + "_nodeInfo2", mungers=[default_root_munger]
    )

    def node_info2(self, *args) -> Any:
        return self._node_info2(*args)
    ...
    _remove_peer2: Method[Callable[..., Any]] = Method(
        namespace + "_removePeer2", mungers=[default_root_munger]
    )

    def remove_peer2(self, *args) -> Any:
        return self._remove_peer2(*args)
...
class AsyncSubbridgeApi(Module):
    ...
    _add_peer2: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_addPeer2", mungers=[default_root_munger]
    )

    async def add_peer2(self, *args) -> Any:
        return await self._add_peer2(*args)
    ...
    _node_info2: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_nodeInfo2", mungers=[default_root_munger]
    )

    async def node_info2(self, *args) -> Any:
        return await self._node_info2(*args)
    ...
    _remove_peer2: Method[Callable[..., Awaitable[Any]]] = Method(
        namespace + "_removePeer2", mungers=[default_root_munger]
    )

    async def remove_peer2(self, *args) -> Any:
        return await self._remove_peer2(*args)
